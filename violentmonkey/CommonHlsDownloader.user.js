...
// @inject-into page
// @downloadURL https://github.com/ssneoh/webvideo-downloader/raw/master/violentmonkey/CommonHlsDownloader.user.js
// @homepageURL https://github.com/ssneoh/webvideo-downloader
// ==/UserScript==
...
function prepare() {
  ...
  $.ready(() => {
    ...
    $.addStyle('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.0.0/css/font-awesome.min.css');
    $.addStyle(`
      .swal2-container {
        font-size: 18px;
        z-index: 10000;
